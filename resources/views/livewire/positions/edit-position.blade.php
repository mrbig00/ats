<div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
    <div class="flex items-center gap-2">
        <flux:button variant="ghost" icon="arrow-left" :href="route('jobs.show', $position)" wire:navigate>
            {{ __('common.back') }}
        </flux:button>
    ...
    <flux:card class="max-w-2xl">
        <form wire:submit="save" class="space-y-6">
            ...
            <div class="flex gap-2">
                ...
                <flux:button type="button" variant="ghost" :href="route('jobs.show', $position)" wire:navigate>
                    {{ __('common.cancel') }}
                </flux:button>
            </div>
        </form>
