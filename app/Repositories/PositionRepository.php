...
class PositionRepository
{
    ...
    {
        return Position::query()->activeRecruitmentSession()->orderBy('title')->get();
    }
    ...
    {
        return Position::query()->activeRecruitmentSession()->count();
    }
    ...
    public function paginate(PositionFilterData $filters): LengthAwarePaginator
    {
        ...
        if (! $filters->includeArchived) {
            $query->activeRecruitmentSession();
    ...
    {
        $query = Position::query()->withCount('candidates')->expiredRecruitmentSession();
